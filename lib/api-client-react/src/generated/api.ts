...
/**
 * @summary Get the active flash sale (public). Returns enabled=false when admin has not configured one.
 */
...
export const getFlashSale = async (
  ...
  return customFetch<FlashSale>(getGetFlashSaleUrl(), {
    ...options,
    method: "GET",
  });
};
...
/**
 * @summary Get flash sale configuration (admin only)
 */
export const getGetAdminFlashSaleUrl = () => {
  return `/api/admin/flash-sale`;
};

export const getAdminFlashSale = async (
  options?: RequestInit,
): Promise<FlashSale> => {
  return customFetch<FlashSale>(getGetAdminFlashSaleUrl(), {
    ...options,
    method: "GET",
  });
};

export const getGetAdminFlashSaleQueryKey = () => {
  return [`/api/admin/flash-sale`] as const;
};
...
>(options?: {
  ...
  const queryKey = queryOptions?.queryKey ?? getGetAdminFlashSaleQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getAdminFlashSale>>
  > = ({ signal }) => getAdminFlashSale({ signal, ...requestOptions });
...
export type GetAdminFlashSaleQueryResult = NonNullable<
  Awaited<ReturnType<typeof getAdminFlashSale>>
>;
export type GetAdminFlashSaleQueryError = ErrorType<unknown>;
...
>(options?: {
  ...
  const queryOptions = getGetAdminFlashSaleQueryOptions(options);
...
/**
 * @summary Create/update the flash sale configuration (admin only)
 */
export const getUpdateAdminFlashSaleUrl = () => {
  return `/api/admin/flash-sale`;
};

export const updateAdminFlashSale = async (
  updateFlashSaleRequest: UpdateFlashSaleRequest,
  options?: RequestInit,
): Promise<FlashSale> => {
  return customFetch<FlashSale>(getUpdateAdminFlashSaleUrl(), {
    ...options,
    method: "PUT",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(updateFlashSaleRequest),
  });
};
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { data: BodyType<UpdateFlashSaleRequest> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
> => {
  ...
  > = (props) => {
    ...
    return updateAdminFlashSale(data, requestOptions);
  };
...
export type UpdateAdminFlashSaleMutationResult = NonNullable<
  Awaited<ReturnType<typeof updateAdminFlashSale>>
>;
export type UpdateAdminFlashSaleMutationBody = BodyType<UpdateFlashSaleRequest>;
