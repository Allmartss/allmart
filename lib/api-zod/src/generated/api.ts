 ...
 */
export const GetAdminFlashSaleResponse = zod.object({
  enabled: zod.boolean(),
  endsAt: zod.string().nullable(),
  productIds: zod.array(zod.number()),
  products: zod.array(
...
export const SendChatMessageResponse = zod.object({
  ...
  stripeCheckoutUrl: zod
    .string()
    .optional()
    .describe("Stripe checkout URL when paymentMethod=stripe"),
  bankDetails: zod
    .object({
      bankName: zod.string(),
    ...
    .optional()
    .describe("Bank details when paymentMethod=bank_transfer"),
});
